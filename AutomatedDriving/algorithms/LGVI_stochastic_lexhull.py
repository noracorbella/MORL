                ...
                for p1 in env.states_agent_right:
                    for p2 in env.states_agent_right:
                        ...
                        for action in range(n_actions):
                            ...
                            if len(new_q_hull) > 1:
                                _, optimal_indices = lex_hull_corrected(new_q_hull, priority_orders=all_priority_orders)
                        ...
                        if len(all_q_vectors) > 1:
                            _, optimal_indices = lex_hull_corrected(all_q_vectors, priority_orders=all_priority_orders)
...
def get_initial_state_hull(Q_hulls, initial_state_indices, n_actions):
    ...
    if len(all_vectors) > 1:
        _, optimal_indices = lex_hull_corrected(all_vectors) 
