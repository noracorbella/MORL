...
def value_iteration(env, theta=1.0, discount_factor=0.7, MNS_filename='dstc_policies/DSTc_VI_MNS.pkl', v_table_file=None):
    """
    ...
    DSTc is fully deterministic
 
    :param env: DSTcEnvironment
