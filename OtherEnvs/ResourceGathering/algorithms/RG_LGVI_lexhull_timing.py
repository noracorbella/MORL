...
from RG_LG_utils import lex_hull_corrected, generate_all_priority_orders, lex_max
...
def LG_VI_lexhull(env, theta=1.0, discount_factor=0.7,
                  MNS_filename='rg_policies/RG_LGVI_lexhull_MNS.pkl',
                  v_hulls_file=None, q_hulls_file=None):
    """
    Lexicographic Hull Value Iteration for Resource Gathering (stochastic MOMDP).
    """
